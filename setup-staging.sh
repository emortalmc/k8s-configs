...
source ./argocd/apps/generate.sh true
...
source ./traefik/install/init.sh $cloudflare_email $cloudflare_dns_api_token true

source ./traefik/internal/generate.sh true
